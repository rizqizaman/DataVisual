...
def create_connection():
    ...
    connection = mysql.connector.connect(
        ...
        user=mysql_config['root'],  # Ganti dengan username Anda
        password=mysql_config[''],  # Ganti dengan password Anda
        database=mysql_config['web_service']  # Ganti dengan nama database Anda
    )
    return connection
